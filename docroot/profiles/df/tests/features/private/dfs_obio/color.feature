...
#    When I click the "#color_scheme_form .color-palette [data-activates]" element
#    When I click the "span:contains('Obio brown')" element
...
#    When I click the "#color_scheme_form .color-palette [data-activates]" element
#    When I click the "span:contains('Obio (default)')" element
#    And I press "Save configuration"
#    And I am on the homepage
