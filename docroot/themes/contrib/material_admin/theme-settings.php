...
function material_admin_form_system_theme_settings_alter(&$form, $form_state) {
  ...
  $form['theme_ui_options']['material_admin_logo'] = array(
    '#type' => 'checkbox',
    '#title' => t('Display logo'),
    '#description' => t('Adds logo to header'),
    '#default_value' => theme_get_setting('material_admin_logo'),
  );

  $form['theme_ui_options']['material_admin_site_name'] = array(
    '#type' => 'checkbox',
    '#title' => t('Display site name'),
    '#description' => t('Adds site name to header'),
    '#default_value' => theme_get_setting('material_admin_site_name'),
  );
